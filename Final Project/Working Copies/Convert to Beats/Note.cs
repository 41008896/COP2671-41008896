    ...
    public class Note : MonoBehaviour
    {
        ...
        public void InitNoteLength(float length)
        {
            ...
            if (applyNoteLenghtTarget)
            {
                ...
                //size.y = length / songManager.secPerBeat * songManager.trackManager.beatSize; // second
                size.y = (length / (float)songManager.MPTK_DeltaTicksPerQuarterNote) * songManager.trackManager.beatSize; // beat
